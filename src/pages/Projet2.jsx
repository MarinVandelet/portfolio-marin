  ...
  return (
    <>
      ...
      <div className="min-h-screen pt-24 pb-16 px-6 text-white max-w-5xl mx-auto">
        ...
        >
          <p className="mb-4">
            Ce projet était un site{" "}
            <span className="text-primary-300 font-semibold">100% statique</span>,
            conçu pour présenter un jeu vidéo fantasy réalisé par des connaissances,
            et permettre son{" "}
            <span className="text-primary-300 font-semibold">
              téléchargement facilement
            </span>{" "}
            (sans backend).
          </p>

          <p className="mb-4">
            L’objectif : une page simple à héberger, légère, responsive et claire,
            qui donne envie de découvrir l’univers du jeu. Même si le projet n’a
            jamais été totalement finalisé, j’en suis fier car c’est l’un de mes{" "}
            <span className="text-primary-300 font-semibold">
              tout premiers sites
            </span>
            : c’est là que j’ai appris les bases solides du HTML/CSS.
          </p>
        </motion.div>
        ...
        >
          ...
          <ul className="space-y-3 text-gray-300 font-['Inter'] leading-relaxed">
            <li>
              • Intégration complète en{" "}
              <span className="text-primary-300 font-semibold">HTML/CSS</span>.
            </li>
            <li>
              • Utilisation de{" "}
              <span className="text-primary-300 font-semibold">Bootstrap</span>{" "}
              pour le responsive.
            </li>
            <li>
              • Conception d’une page dédiée au{" "}
              <span className="text-primary-300 font-semibold">
                téléchargement du jeu
              </span>.
            </li>
            <li>
              • Travail collaboratif et apprentissage des bonnes pratiques.
            </li>
          </ul>
        </motion.div>
        ...
        >
          ...
          <p className="mb-10">
            Le site remplissait son objectif : une vitrine simple, rapide à héberger,
            avec une navigation claire et une mise en avant du téléchargement.
            C’est un projet clé dans mon apprentissage du web.
          </p>
          ...
          >
            <iframe
              ...
              src="https://www.youtube.com/embed/fMiw1BUnPlw"
