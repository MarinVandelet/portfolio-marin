...
export default function Projet4() {
  return (
    <div className="min-h-screen pt-24 pb-16 px-6 text-white max-w-5xl mx-auto">
      ...
      >
        <p className="mb-4">
          RapActus est un site d’actualité dédié au rap : sorties d’albums, collaborations,
          événements, mais aussi un peu d’analyse et de critique. L’objectif était d’avoir une
          plateforme claire, cohérente visuellement et simple à administrer.
        </p>

        <p className="mb-4">
          Le projet a été pensé autour d’une charte sobre (noir / blanc / verts), d’une
          navigation efficace et d’une structure de contenu propre : catégories, étiquettes,
          recherche et commentaires (activés pour la démo).
        </p>
      </motion.div>
      ...
      >
        ...
        <ul className="space-y-3 text-gray-300 font-['Inter'] leading-relaxed">
          <li>
            • Mise en place de l’arborescence du site : Accueil, Actualités, À propos, Contact, Shop.
          </li>
          <li>
            • Design & intégration sous WordPress avec un rendu “pro” (typographie, couleurs, sections, footer).
          </li>
          <li>
            • Structuration des posts : miniatures, extrait, catégories/étiquettes, navigation “suivant”, commentaires.
          </li>
          <li>
            • Optimisations : travail SEO on-site (titres, méta, etc.) et cache/performances.
          </li>
        </ul>
      </motion.div>
      ...
      >
        ...
        <p className="mb-4">
          Le site propose une expérience simple et structurée : une home “vitrine” avec CTA
          vers les pages clés, une page actualités bien filtrable (catégories, tags, recherche),
          et des pages complémentaires (à propos / contact / shop) cohérentes visuellement.
        </p>

        <p>
          C’était un vrai exercice de gestion de contenu : penser l’architecture, rendre l’édition
          facile, et améliorer le référencement/chargement avec des outils WordPress adaptés.
        </p>
      </motion.div>
      ...
      <div className="mt-12">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {/* Catégories / Tags (structure contenu) */}
          <span className="px-4 py-2 bg-gray-900/60 border border-gray-700 rounded-lg text-sm font-['Inter'] flex items-center gap-2">
